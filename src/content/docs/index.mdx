...
<CardGrid stagger>
  ...
  <Card title="AI-Friendly Docs" icon="rocket">
    Every page is available as raw Markdown for LLMs and agents, plus a full [`llms.txt`](/llms.txt) index. [Learn more](/ai/using-with-ai/).
  </Card>
</CardGrid>
